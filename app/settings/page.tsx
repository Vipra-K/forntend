  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto p-8 lg:p-12">
        <SkeletonBlock className="h-4 w-36 mb-10" />
        <SkeletonBlock className="h-8 w-56 mb-3" />
        <SkeletonBlock className="h-5 w-80 mb-12" />
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2 space-y-8">
            <div className="border border-slate-200 rounded-2xl p-8 space-y-5">
...
export default function SettingsPage() {
  ...
  const profileHasChanges = name !== (user.name || "") || email !== user.email;
      ...
      <div className="max-w-4xl mx-auto p-8 lg:p-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-1 space-y-2">
            <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4 ml-2">
              Preferences
            </div>
          ...
          <div className="md:col-span-2 space-y-12">
            ...
            {/* Security Section - Only show for LOCAL users */}
            {user?.provider !== "EZIYO" && (
              <section className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
                <div className="flex items-center space-x-3 mb-8 border-b border-slate-100 pb-4">
