      ...
      <main className="p-8 lg:p-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-10">
            ...
            <p className="text-sm text-slate-500 mt-1 font-medium">Manage form configuration and data visibility.</p>
          </div>
          ...
          <form onSubmit={handleUpdate} className="space-y-10">
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-6">
                <div className="space-y-1.5">
                  <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Form Title</label>
                  <input 
                    value={form.title}
            ...
            <section className="space-y-6">
              <div className="flex items-center space-x-2 border-b border-slate-100 pb-4">
                 ...
                 <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider">Public Access</h3>
              </div>
              
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Custom Link Slug</label>
                ...
                <p className="text-[10px] text-slate-400 mt-2 ml-1">
                  Note: Changing this will invalidate existing links to this form.
                </p>
              </div>
            </section>
               ...
               <div className="bg-red-50 border border-red-100 p-8 rounded-xl">
                  <div className="flex items-center justify-between">
                     <div className="space-y-1">
                        <h3 className="text-sm font-bold text-red-600 uppercase tracking-wide">Delete Form</h3>
                        <p className="text-xs text-red-500/80 font-medium">Permanently remove this form and all its submissions.</p>
                     </div>
                     <button 
                       type="button"
          ...
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-6 bg-slate-900/40 backdrop-blur-[2px]">
            ...
            >
              ...
              <p className="text-slate-500 text-sm mb-8 font-medium">
                This action is irreversible. All form data will be permanently deleted.
              </p>
