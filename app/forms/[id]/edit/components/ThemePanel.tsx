...
export function ThemePanel({ form, onUpdate }: ThemePanelProps) {
  return (
    <div className="space-y-6">
      <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">Theme Settings</h3>
      ...
      <div className="pt-8 border-t border-slate-200">
        <button 
          onClick={() => toast.success('Theme settings are saved automatically!')}
