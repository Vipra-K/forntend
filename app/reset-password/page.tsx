      ...
      <AnimatePresence mode="wait">
        {error && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -4 }}
            className="bg-red-50 border border-red-100 text-red-600 text-[11px] font-semibold uppercase tracking-wider p-4 rounded-lg flex items-start space-x-2"
          >
        ...
        >
          <div className="bg-white border border-slate-200 p-8 lg:p-12 rounded-2xl shadow-xl">
            <div className="text-center mb-10">
              ...
              <h1 className="text-2xl font-bold text-slate-900 mb-2 tracking-tight">Set New Password</h1>
              <p className="text-sm text-slate-500">Choose a strong password to secure your account.</p>
            </div>
            <ResetPasswordForm />
          </div>
        </motion.div>
