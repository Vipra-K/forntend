          ...
          >
            <div className="mb-10">
              ...
              <p className="text-slate-500 mt-2 font-medium">
                Define a title for your form to get started.
              </p>
            </div>
            ...
            <form onSubmit={handleCreateForm} className="space-y-6">
              ...
              <div className="flex space-x-3 pt-6">
                <button
                  ...
                  className="flex-1 py-3.5 bg-slate-100 text-slate-600 font-bold text-sm rounded-xl hover:bg-slate-200 transition-all"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-3.5 bg-slate-900 text-white font-bold text-sm rounded-xl hover:bg-slate-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
