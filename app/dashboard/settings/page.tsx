  ...
  return (
    <div className="max-w-6xl px-8 lg:px-12 py-12">
      <div className="mb-12">
        ...
        <SkeletonBlock className="h-10 w-48 mb-3" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3">
          <div className="bg-white border border-slate-100 rounded-2xl p-8 space-y-6">
            ...
            <SkeletonBlock className="h-12 w-full" />
            <SkeletonBlock className="h-10 w-36 ml-auto" />
          </div>
        </div>
      </div>
    </div>
...
export default function SettingsPage() {
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      const data = { name: res.data.name || "", email: res.data.email };
      setProfile(data);
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === "notifications" && (
              ...
              >
                ...
                <p className="text-slate-500 font-medium max-w-md mx-auto mb-8">
                  Configure how and when you want to receive alerts about form
                  submissions and account activity.
                </p>
            ...
            {activeTab === "billing" && (
              ...
              >
                ...
                <p className="text-slate-500 font-medium max-w-md mx-auto mb-8">
                  Manage your subscription plan, payment methods, and view
                  billing history.
                </p>
                <div className="inline-flex px-6 py-3 bg-slate-100 text-slate-500 rounded-xl text-sm font-bold">
                  Coming Soon
